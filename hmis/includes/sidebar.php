...
<div class="sidebar" id="sidebar">
    ...
    <ul>
        ...
        <li>
            <a href="/modules/doctors.php" class="<?= $current_page == 'doctors.php' ? 'active' : '' ?>">
                <i class="fa-solid fa-user-doctor"></i> Doctors
            </a>
        </li>
        <li>
            <a href="/modules/billing.php" class="<?= $current_page == 'billing.php' ? 'active' : '' ?>">
        ...
        <li>
            <a href="/modules/pharmacy.php" class="<?= $current_page == 'pharmacy.php' ? 'active' : '' ?>">
                <i class="fa-solid fa-pills"></i> Pharmacy
            </a>
        </li>
        <li>
            <a href="/modules/lab.php" class="<?= $current_page == 'lab.php' ? 'active' : '' ?>">
                <i class="fa-solid fa-flask-vial"></i> Lab
            </a>
        </li>
        <li>
            <a href="/modules/radiology.php" class="<?= $current_page == 'radiology.php' ? 'active' : '' ?>">
        ...
        <li>
            <a href="/modules/admin.php" class="<?= $current_page == 'admin.php' ? 'active' : '' ?>">
