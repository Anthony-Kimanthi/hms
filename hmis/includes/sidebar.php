...
<div class="sidebar" id="sidebar">
    <h2>Modules</h2>
    <ul>
        <li><a href="/hmis/ndex.php" class="<?= $current_page == 'index.php' ? 'active' : '' ?>"><i class="fa-solid fa-hospital"></i> Home</a></li>
        ...
        <li><a href="/hmis/modules/admin.php" class="<?= $current_page == 'admin.php' ? 'active' : '' ?>"><i class="fa-solid fa-gear"></i> Admin</a></li>
    </ul>
</div>
