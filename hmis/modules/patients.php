...
$pageTitle = "patients";      // e.g., "Billing"
$pageHeader = "Patients";     // e.g., "Billing"
$pageDescription = "Search existing patients and register new."; // e.g., "Process payments and generate invoices."
?>
