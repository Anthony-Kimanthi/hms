...
<body>
    <div class="content with-header">
        ...
        <div class="card">
            <h2><i class="fa-solid fa-users"></i> Patient Overview</h2>
        ...
        <br>
        <a href="register.php" class="btn"><i class="fa fa-plus"></i> Register New Patient</a>
    </div>
