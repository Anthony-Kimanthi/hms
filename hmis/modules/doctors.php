...
$pageTitle = "Doctors";      // e.g., "Billing"
$pageHeader = "Doctors";     // e.g., "Billing"
$pageDescription = "Dr's Room to make examination, order tests and prescribe drugs."; // e.g., "Process payments and generate invoices."
?>
